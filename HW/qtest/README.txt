...
Prerequisites:
QTest requires a working installation of Java JDK version 11 or higher. Make sure the commands "java" and "javac" are both in the system path (accessible from a terminal).
...
Note: The Exam module will activate your webcam and record your screen. Make sure you allow webcam and screen recording permissions in your Operating Systems's settings.
